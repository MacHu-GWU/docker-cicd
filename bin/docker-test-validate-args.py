...
"""
used by ``./bin/docker-test.sh`` file
"""
...
if __name__ == "__main__":
    ...
    test_shell_script = join(build_context_dir, "test.sh")
    if not os.path.exists(test_shell_script):
        print(Style.RESET + "test script " + Style.CYAN + "'{}'".format(test_shell_script) + Style.RED + " not exists!")
        raise_error()
